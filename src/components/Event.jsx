...
function Event() {
  return (
    <section className="bg-white shadow-md rounded-lg font-mono overflow-hidden w-full p-4">
        <h1 className="font-bold">Sự kiện</h1>
        <div className='grid grid-cols-3 gap-4 mt-4 pb-2'>
            <div className='col-span-3 lg:col-span-1 flex cursor-pointer hover:bg-pink-50 duration-500 border-2 flex-col items-center py-8 gap-2 rounded-lg'>
                ...
                <h2 className='text-center text-[14px] px-8 font-semibold'>Đang hẹn hò với Nguyễn Thanh Phương</h2>
